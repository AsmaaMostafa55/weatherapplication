...
// console.log(ssearch.value);
 ...
 async function getdata(country){
     var response2=await fetch(`http://api.weatherapi.com/v1/forecast.json?key=3acb9d4bf94143eb9e3192635240401&q=${country}&days=3&aqi=no&alerts=no`);
    ...
    var cartona='';
     for(var i=0;i<5;i++){
         ...
         <div class="item  p-2">
          ...
          <div class="middle d-flex justify-content-between p-4">
